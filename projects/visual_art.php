    ...
    <dir class="item-1-3 pic-hover-container container">
        ...
        <dir class="pic-hover-text">
            ...
            <p>
                ...
                <a href='https://www.wolframscience.com/nks/p155--continuous-cellular-automata/'>continuous cellular automata</a>.
                The brightness of each pixel (b) is dependant on the brightness of the 3 pixels immediately above it (p1, p2, p3).
            </p>
            <p>
                Here, 
                <br>
